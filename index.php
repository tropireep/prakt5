...
<head>
    ...
    <style>
        ...
        .container {
            width: 100%;
            max-width: 500px;
            border: 1px solid #000000; /* Квадратна рамка */
            padding: 30px;
        }
        ...
        /* Окрема кнопка "Назад" (білого кольору) */
        .back-btn {
...
<body>
    ...
    <div class="container">
        <h1>Практична робота №5<br><br><small></h1>
